    ...
    return (
        <>
            <div id="styles-setup" className={styles.search_container}>
                    <img className={styles.search_item} src="assets/search.png" alt="search-icon"/>
                    <input className={styles.search} placeholder="Search for your location" type="text"/>
            </div>
                <iframe id="map" className={styles.map}
            ...
            <img src="assets/background.png" alt="background" className={styles.background}/>
        </>
    )
};

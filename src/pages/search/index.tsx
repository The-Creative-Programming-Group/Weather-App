     ...
     <div className="flex flex-col items-center">
      ...
      <div className="relative mt-24 left-1/2 transform -translate-x-1/2  w-3/5 h-100% border-solid border-[#2d3142] border-8">
        ...
        {searchValue.length > 0 ? (
          <button onClick={checkCity} className="absolute z-30 bottom-14 right-16 w-40 h-10 text-white bg-[#2d3142] rounded text-2xl hover:shadow-2xl transition duration-500 ease-in-out">
            <p>{"Continue ->"}</p>
          </button>
        ) : null}
      </div>
